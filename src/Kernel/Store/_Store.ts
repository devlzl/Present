...
export type OriginType = undefined | number | string | boolean | OriginMap | OriginArray
...
export const isStoreType = (object: FullType): boolean => {
  return object instanceof MapStore || object instanceof ArrayStore || object instanceof TextStore
}
